...
public class Main {
    ...
    public static void travelAndSearch(Node root, Node node , int data){
        if(node == null){
            return ;
        }
        travelAndSearch(root,node.left , data);
        ...
        travelAndSearch(root,node.right,data);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        travelAndSearch(root,root,data);
