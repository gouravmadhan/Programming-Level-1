// public 1. You are given a partially written LinkedList class.
...
// 4. Input and Output is managed for you.class Reverse A Linked List (data Iterative) {
    ...
    public static class LinkedList {
        ...
        public void reverseDI() {
            ...
            while (left < right) {
                ...
                Node ld = getNode(left);
                Node rd = getNode(right);
                int temp = ld.data;
                ld.data = rd.data;
                rd.data = temp;
                left++;
