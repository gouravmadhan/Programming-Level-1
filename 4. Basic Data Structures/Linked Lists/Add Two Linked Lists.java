...
public class Main {
    ...
    public static class LinkedList {
        ...
        public static int getHelpToAdd(Node one , int pv1 , Node two, int pv2 , LinkedList res){
            if(pv1 == 0 && pv2 == 0){
                return 0;
            }
            int data = 0;
            if(pv1>pv2){
                int oc = getHelpToAdd(one.next ,pv1-1,two,pv2,res);
                data = one.data+oc;
            }else if(pv1<pv2){
                int oc = getHelpToAdd(one ,pv1,two.next,pv2-1,res);
                data = two.data + oc;
            }else{
                int oc = getHelpToAdd(one.next ,pv1-1,two.next,pv2-1,res);
        ...
        public static LinkedList addTwoLists(LinkedList one, LinkedList two) {
            ...
            LinkedList res = new LinkedList();
            int oc = getHelpToAdd(one.head,one.size,two.head,two.size,res);
            if(oc>0){
                res.addFirst(oc);
            }
            return res;
